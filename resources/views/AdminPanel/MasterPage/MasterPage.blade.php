...
<html lang="en" >
  ...
  <head>
    ...
    <title>Hotel In Hand| Default Forms
    </title>
              ...
              <ul class="kt-menu__nav ">
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open" aria-haspopup="true"  data-ktmenu-submenu-toggle="hover">
                  <a  href="{{url('javascript:;')}}" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text">Admin 
                    </span>
                   ...
                   <!--  <span class="kt-menu__arrow">
                    ...
                    <ul class="kt-menu__sub">
                      <li class="kt-menu__item  {{Request::is('dashboard')?'  kt-menu__item--active':''}}" aria-haspopup="true" >
                        ...
                        <li class="kt-menu__item {{Request::is('foodcategory')?'  kt-menu__item--active':''}} " aria-haspopup="true" >
                        <a  href="{{url('foodcategory')}}" class="kt-menu__link ">
                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                            <span>
                            </span>
                          </i>
                          <span class="kt-menu__link-text">Manage Food Category
                          </span>
                        </a>
                      </li>

                      <li class="kt-menu__item  {{Request::is('food')?'  kt-menu__item--active':''}}" aria-haspopup="true" >
                        <a  href="{{url('food')}}" class="kt-menu__link ">
                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                            <span>
                            </span>
                          </i>
                          <span class="kt-menu__link-text">Manage Food
                          </span>
                        </a>
                      </li>
                           <li class="kt-menu__item {{Request::is('usertype')?'  kt-menu__item--active':''}}" aria-haspopup="true" >
                        <a  href="{{url('usertype')}}" class="kt-menu__link ">
                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                            <span>
                            </span>
                          </i>
                          <span class="kt-menu__link-text">Manage User Type
                          </span>
                        </a>
                      </li>
                      <li class="kt-menu__item {{Request::is('user')?'  kt-menu__item--active':''}}" aria-haspopup="true" >
                        <a  href="{{url('user')}}" class="kt-menu__link ">
                          ...
                          <span class="kt-menu__link-text">Manage User
                          </span>
                        </a>
                      </li>
                      <li class="kt-menu__item {{Request::is('dtable')?'  kt-menu__item--active':''}}" aria-haspopup="true" >
                        <a  href="{{url('dtable')}}" class="kt-menu__link ">
                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                            <span>
                            </span>
                          </i>
                          <span class="kt-menu__link-text">Manage Dining Table
                          </span>
                        </a>
                      </li>
                           <li class="kt-menu__item {{Request::is('facility')?'  kt-menu__item--active':''}}" aria-haspopup="true" >
                        <a  href="{{url('facility')}}" class="kt-menu__link ">
                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                            <span>
                            </span>
                          </i>
                          <span class="kt-menu__link-text">Manage Room Facilities
                          </span>
                        </a>
                      </li>
                 
                 
                      <li class="kt-menu__item {{Request::is('roomcategory')?'  kt-menu__item--active':''}}" aria-haspopup="true" >
                        <a  href="{{url('roomcategory')}}" class="kt-menu__link ">
                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                            <span>
                            </span>
                          </i>
                          <span class="kt-menu__link-text">Manage Room Category
                          </span>
                        </a>
                      </li>
                      <li class="kt-menu__item {{Request::is('room1')?'  kt-menu__item--active':''}}" aria-haspopup="true" >
                        <a  href="{{url('room1')}}" class="kt-menu__link ">
                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                            <span>
                            </span>
                          </i>
                          <span class="kt-menu__link-text">Manage Room
                          </span>
                        </a>
                      </li>
                      <li class="kt-menu__item {{Request::is('service')?'  kt-menu__item--active':''}}" aria-haspopup="true" >
                        <a  href="{{url('service')}}" class="kt-menu__link ">
                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                            <span>
                            </span>
                          </i>
                          <span class="kt-menu__link-text">Manage Service Room
                          </span>
                        </a>
                      </li>
                    </ul>
        ...
        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
          ...
          <div class="kt-notification">
            <div class="kt-notification__custom">
              <a href="{{url('logout')}}"  class="btn btn-label-brand btn-sm btn-bold">Sign Out
              </a>
            </div>
          </div>
          <!--end: Navigation -->    
