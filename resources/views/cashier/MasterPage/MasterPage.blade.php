              ...
              <ul class="kt-menu__nav ">
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open" aria-haspopup="true"  data-ktmenu-submenu-toggle="hover">
                  <a  href="{{url('javascript:;')}}" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text">Cashier
                    </span>
                  ...
                  <div class="kt-menu__submenu ">
                   <!--  <span class="kt-menu__arrow">
                    ...
                    <ul class="kt-menu__sub">
                        <li class="kt-menu__item {{Request::is('tablecart')?'  kt-menu__item--active':''}}" aria-haspopup="true" >
                        <a  href="{{url('tablecart')}}" class="kt-menu__link ">
                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                            <span>
                            </span>
                          </i>
                          <span class="kt-menu__link-text">Manage Table Cart
                          </span>
                        </a>
                      </li>
                      <li class="kt-menu__item {{Request::is('foodmenu')?'  kt-menu__item--active':''}}" aria-haspopup="true" >
                        <a  href="{{url('foodmenu')}}" class="kt-menu__link ">
                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                            <span>
                            </span>
                          </i>
                          <span class="kt-menu__link-text">Manage Parsal Order
                          </span>
                        </a>
                      </li>
                           <li class="kt-menu__item {{Request::is('token')?'  kt-menu__item--active':''}} " aria-haspopup="true" >
                        <a  href="{{url('token')}}" class="kt-menu__link ">
                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                            <span>
                            </span>
                          </i>
                          <span class="kt-menu__link-text">Manage Token
                          </span>
                        </a>
                      </li>
                     </ul>
